...
#define VSENSE_3V3_Pin GPIO_PIN_5
#define VSENSE_3V3_GPIO_Port GPIOA
#define VSENSE_5V_Pin GPIO_PIN_6
#define VSENSE_5V_GPIO_Port GPIOA
#define VSENSE_6V_Pin GPIO_PIN_7
#define VSENSE_6V_GPIO_Port GPIOA
#define VSENSE_54V_Pin GPIO_PIN_0
#define VSENSE_54V_GPIO_Port GPIOB
...
#define ST_CH3_Pin GPIO_PIN_4
#define ST_CH3_GPIO_Port GPIOB
#define ST_CH2_Pin GPIO_PIN_5
#define ST_CH2_GPIO_Port GPIOB
#define ST_CH1_Pin GPIO_PIN_6
#define ST_CH1_GPIO_Port GPIOB
